...
public final class BookRepository {
    ...
    public static synchronized List<String> getGenres() {
    ...
    public static synchronized Book getBookById(int id) {
        for (Book book : BOOKS) {
            if (book.getId() == id) {
                return book;
            }
    ...
    public static synchronized void toggleLike(int id) {
    ...
    public static synchronized void addBook(
            String title,
            String author,
            int year,
            String blurb,
    ...
    private static synchronized void addBookResource(
            String title,
            String author,
            int year,
            String blurb,
